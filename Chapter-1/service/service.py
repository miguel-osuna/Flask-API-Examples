...
# The notification fields act as a filter
notification_fields = {
    "id": fields.Integer,
...
class NotificationList(Resource):
    ...
    def post(self):
        ...
        parser.add_argument(
            "ttl", type=int, required=True, help="Time to live cannot be blank!"
        )
        parser.add_argument(
...
service.add_resource(
    Notification, "/serivice/notifications/<int:id>/", endpoint="notification_endpoint"
)
